    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <section class="swiper-slide">
                <div class="bg_top"><p>您的八字喜用神为<?php echo ($xiys); ?>，从事属<?php echo ($xiys); ?>行业较有利于您的事业发展</p></div>
                <div class="end_msg">
                    <div class="msg_title"><span class="icon_line"></span>属<?php echo ($xiys); ?>的行业有</div>
                    <div class="msg_cont">
                        <p><?php echo ($cause['cause0']); ?></p>
            ...
            <section class="swiper-slide">
                <div class="bg_top"><p>您的八字喜用神为<?php echo ($xiys); ?>，从事属<?php echo ($xiys); ?>行业较有利于您的事业发展</p></div>
                <div class="end_msg">
                    <div class="msg_title"><span class="icon_line"></span>有利事业的方向</div>
                    <div class="msg_cont">
                        <p><?php echo ($cause['cause1']); ?></p>
                    </div>
                </div>
            ...
            <section class="swiper-slide">
                <div class="bg_top"><p>与三合贵人共事或者得到三合贵人的帮助有利于你的事业的发展，有利于你的三合生肖是</p></div>
                <div class="end_msg">
                    <div class="msg_title"><span class="icon_line"></span>三合贵人</div>
                    <div class="msg_cont">
                        <p><?php echo ($shengxiaosh['name']); ?>  =>  <?php echo ($shengxiaosh['namesh1']); ?>  <?php echo ($shengxiaosh['namesh2']); ?></p>
                    </div>
                </div>
            </section>
