    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <section class="swiper-slide">
                <div class="bg_top"><p>分析您一生的爱情,剖析您今生姻缘运势，分析当下感情状况和不利因素的破解之法。</p></div>
                <div class="end_msg">
                    <div class="msg_title"><span class="icon_line"></span><?php echo ($title1); ?></div>
                    <div class="msg_cont">
                        <p><?php echo ($lovefenxi); ?></p>
                    </div>
                </div>
            ...
            <section class="swiper-slide">
                ...
                <div class="end_msg">
                    ...
                    <div class="msg_cont">
                        ...
                        <?php if(is_array($arrtaohua)): foreach($arrtaohua as $key=>$value): ?><p class="list_t" ><img src="/bazipaipan/Public/images/bzjp_img/<?php echo ($value['image']); ?>" alt="墙内桃花" class="list_pic">  <?php echo ($value['name']); ?>:  <?php echo ($value['brief']); ?></p><?php endforeach; endif; ?>
            ...
            <section class="swiper-slide">
                ...
                <div class="end_msg">
                    ...
                    <div class="msg_cont">
                        <?php if(is_array($arrtaohua)): foreach($arrtaohua as $key=>$value): ?><p class="list_t"><?php echo ($value['name']); ?>:</p>
